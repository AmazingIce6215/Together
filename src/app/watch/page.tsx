...
export default function WatchPage() {
  const categories = resources.filter((r) => r.pillar === "watch");
  ...
  return (
    <div className="flex flex-col gap-8 py-10">
      <div className="flex flex-col gap-2">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Video Lectures</h1>
        <p className="text-sm text-zinc-500">
          Curated video resources from top medical educators — anatomy to clinical skills.
        </p>
      </div>

...
export default function PracticePage() {
  const categories = resources.filter((r) => r.pillar === "practice");
    ...
    <div className="flex flex-col gap-8 py-10">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-medium tracking-widest uppercase text-tertiary">
            Practice
          </span>
        </div>
        <h1 className="text-2xl font-semibold tracking-tight">Question Banks &amp; USMLE Prep</h1>
        <p className="text-sm text-zinc-500">
          Practice with the best question banks, flashcards, and exam prep resources.
        </p>
      </div>
            ...
            <div className="gradient-border-surface flex flex-col gap-4 rounded-[29px] p-5">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-tertiary/20">
                  <PenLine className="h-4 w-4 text-tertiary" />
                </div>
